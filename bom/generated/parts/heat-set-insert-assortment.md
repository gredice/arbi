# Heat-set threaded insert assortment
...
- Part ID: `heat-set-insert-assortment`
- Unit: each
- Kind: consumable
- Lifecycle: active
...
- M3/M4/M5 brass inserts for printed assemblies.
...
| --- | ---: | --- | --- |
| [Shared procurement stock (non-physical stock)](../../../bom/README.md#physical-ownership) | 1 each | base | — |
