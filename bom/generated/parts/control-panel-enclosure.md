# Central outdoor electrical cabinet
...
- Part ID: `control-panel-enclosure`
- Unit: each
- Kind: component
- Lifecycle: active
...
- IP65+ approx. 400×300/400×200 mm, large enough for both 48 V PSUs, Pico, protection, fusing and cable management.

## Notes

IP65/IP66 cabinet with equivalent usable internal dimensions is preferred if cheaper.
...
| --- | ---: | --- | --- |
| [Control cabinet](../../../docs/assemblies/control-cabinet/README.md) | 1 each | base | — |
