# CL57Y-V20 closed-loop motor driver
...
- Part ID: `cl57y-v20-driver`
- Unit: each
- Kind: component
- Lifecycle: active
- Disciplines: electronics, electrical
- Traits: off-the-shelf

## Requirements

- Provided by the selected StepperOnline 4-axis V2.0 kit; exact included model must match the captured kit specification.
...
| --- | ---: | --- | --- |
| [Winch set](../../../docs/assemblies/winch/README.md) | 4 each | base | Component supplied through a multi-part purchase bundle. |
